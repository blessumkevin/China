...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <layoutAssignments>
        <layout>AssetAction-资产操作 布局</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>AssetActionSource-资产操作来源 布局</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>AssetRelationship-Asset Relationship Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>AssetStatePeriod-资产状态周期 布局</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>CaseMilestone-个案重大事件布局</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>ContractLineItem-合同行项目布局</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Entitlement-权利布局</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>FinanceBalanceSnapshot-财务余额快照 布局</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>FinanceTransaction-财务交易 布局</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>LegalEntity-法人实体 布局</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>ProcessException-进程异常 布局</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>ReturnOrderItemAdjustment-退货单项目调整 布局</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>ReturnOrderItemTax-退货单项目税 布局</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>ServiceContract-服务合同布局</layout>
    </layoutAssignments>
    <layoutAssignments>
